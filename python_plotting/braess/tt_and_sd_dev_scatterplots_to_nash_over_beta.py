...
if __name__ == '__main__':
    ...
    # tt_df = compute_deviation_to_reference_df(tt_path, betas=BETAS, seeds=seeds_to_use, mode="tt")
    #
    ...
    #  should it maybe be split into two files/modules? NOTE: this is done now
    # fig_tt_avg.savefig(
    ...
    # sd_df = compute_deviation_to_reference_df(sd_path, betas=BETAS, seeds=seeds_to_use, mode="sd")
    #
