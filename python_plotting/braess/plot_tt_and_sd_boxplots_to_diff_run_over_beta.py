...
if __name__ == '__main__':
    ...
    # TODO does it make sense to say "avg_over_all"?
    ...
    # TODO continue here: do I want/need to support any averaging here, or should it just always be assumed that tt_path_2 is fixed?
    #  I guess it would be a nice addition to support that the second path can be averaged, since then I could also use
    #  this script to compare e.g. all runs to their average or something.
    #  BUT that would require a larger change, since the path that is passed here is still a placeholder for beta,
    #  so the averaging would have to be done for each beta inside the compute_deviation_to_reference_df function
